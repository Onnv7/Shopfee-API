...
public class GetOrderQueueResponse {
    ...
    public static class OrderInfo {
        ...
        public static OrderInfo fromOrderBillEntity(OrderBillEntity orderBillEntity) {
            ...
            response.setPhoneNumber(orderBillEntity.getReceiverInformation().getPhoneNumber());
            ...
            response.setReceiveTime(orderBillEntity.getReceiverInformation().getReceiveTime());
