...
public class KafkaConstant {
    ...
    public static final String TRACKING_USER_PRODUCT_TOPIC = "tracking-user-product";
    public static final String TRACKING_USER_PRODUCT_GROUP_ID = "tracking-user-product-group";

    public static final String RATING_PRODUCT_TOPIC = "collect-rating-product";
    public static final String RATING_PRODUCT_GROUP_ID = "collect-rating-product-group";
