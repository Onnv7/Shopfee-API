...
public class GoongDistanceMatrix {
    ...
    public DistanceMatrixResponse getDistanceMatrix(String origins, String destinations, String vehicle) {
        ...
        try {
            String url = String.format(endpointUrl, origins, destinations, vehicle, goong.getApiKey());
            ...
            throw new ShopfeeException(ShopfeeErrorCode.SupErrorCode.NOT_FOUND, "Goong could not find the location with the posted coordinates");
        }
        catch (Exception e) {
            throw new ShopfeeException(ShopfeeErrorCode.SupErrorCode.SERVER_ERROR, e.getMessage());
        }
