...
import static com.hcmute.shopfee.module.vnpay.VNPayConstant.VNP_SECURE_HASH_KEY;

public class VNPayRefund {
    private final VNPay vnPay;

    public VNPayRefund(VNPay vnPay) {
        this.vnPay = vnPay;
    }
    /**
     ...
     */
    public  Map<String, Object> refund(HttpServletRequest req, String timeId, long amount, String invoiceCode, String refundType)
            throws IOException {
