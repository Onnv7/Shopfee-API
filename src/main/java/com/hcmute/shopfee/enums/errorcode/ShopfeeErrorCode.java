...
public enum ShopfeeErrorCode {
    ...
    CANT_CRUD_ADMIN_ACCOUNT(1501, ErrorConstant.CANT_CRUD_ADMIN_ACCOUNT, SupErrorCode.FORBIDDEN),
    CANT_CRUD_MANAGER_ACCOUNT(1502, ErrorConstant.CANT_CRUD_MANAGER_ACCOUNT, SupErrorCode.FORBIDDEN),
    CANT_CRUD_EMPLOYEE_ACCOUNT_OF_ANOTHER_BRANCH(1503, ErrorConstant.CANT_CRUD_EMPLOYEE_ACCOUNT_OF_ANOTHER_BRANCH, SupErrorCode.FORBIDDEN),
    ...
    CANT_IMPORT(1303, ErrorConstant.CANT_IMPORT, SupErrorCode.DATA_SEND_INVALID),
    // =======================================================================
