...
public class RouterConstant {
    ...
    // ENDPOINT URL EMPLOYEE AUTH =================================================================
    public static final String POST_EMPLOYEE_AUTH_LOGIN_SUB_PATH = "/login";
    public static final String POST_EMPLOYEE_AUTH_LOGOUT_SUB_PATH = "/logout";
    public static final String POST_EMPLOYEE_AUTH_REFRESH_TOKEN_SUB_PATH = "/refresh-token";
    public static final String POST_EMPLOYEE_AUTH_REGISTER_SUB_PATH = "";
    // ENDPOINT URL USER AUTH =================================================================
    public static final String POST_USER_AUTH_REGISTER_SUB_PATH = "/register";
    public static final String POST_USER_AUTH_SEND_CODE_TO_REGISTER_SUB_PATH = "/register/send-code";
