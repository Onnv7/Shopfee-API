...
public class RouterConstant {
    ...
    public static final String POST_PRODUCT_CREATE_BEVERAGE_FROM_SUB_PATH = PRODUCT_BASE_PATH + POST_PRODUCT_CREATE_FROM_FILE_SUB_PATH;
    ...
    public static final String GET_EMPLOYEE_BY_BRANCH_ID_PATH = EMPLOYEE_BASE_PATH + GET_EMPLOYEE_BY_BRANCH_ID_SUB_PATH;
    ...
    public static final String GET_ORDER_REFUND_REQUEST_SUB_PATH = ORDER_ID_PATH;
    public static final String GET_ORDER_REFUND_REQUEST_PATH = ORDER_REFUND_BASE_PATH + GET_ORDER_REFUND_REQUEST_SUB_PATH;
    ...
    public static final String GET_COUPON_RELEASE_LIST_SUB_PATH = "/release";
    ...
    public static final String POST_COUPON_GET_VALIDATE_COUPON_LIST_PATH = COUPON_BASE_PATH + POST_COUPON_GET_VALIDATE_COUPON_LIST_SUB_PATH;
    public static final String POST_COUPON_CHECK_LIST_IN_CART_SUB_PATH = "/check-coupon-in-cart";
    public static final String POST_COUPON_CHECK_LIST_IN_CART_PATH = COUPON_BASE_PATH + POST_COUPON_CHECK_LIST_IN_CART_SUB_PATH;
    public static final String GET_COUPON_REWARD_OF_COUPON_LIST_SUB_PATH = COUPON_ID_PATH + "/reward";
    public static final String GET_COUPON_REWARD_OF_COUPON_LIST_PATH = COUPON_BASE_PATH + GET_COUPON_REWARD_OF_COUPON_LIST_SUB_PATH;
