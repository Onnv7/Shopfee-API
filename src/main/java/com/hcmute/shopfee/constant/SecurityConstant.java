...
public class SecurityConstant {
    ...
    public static final String[] GET_ADMIN_PATH = {
            ...
            GET_COUPON_PRODUCT_GIFT_DETAIL_BY_ID_PATH
    ...
    public static final String[] POST_ADMIN_PATH = {
            ...
            POST_PRODUCT_CREATE_FROM_SUB_PATH, POST_COUPON_CREATE_ORDER_TYPE_PATH,
            POST_COUPON_CREATE_AMOUNT_OFF_PRODUCT_TYPE_PATH
    };
