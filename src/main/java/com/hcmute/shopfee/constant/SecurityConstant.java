...
public class SecurityConstant {
    ...
    public static final String[] GET_AUTH_WHITELIST = {
            ...
            GET_BRANCH_NEAREST_PATH, GET_ORDER_SHIPPING_FEE_PATH, GET_PRODUCT_REVIEW_STATISTIC_BY_PRODUCT_ID_PATH
    };
    public static final String[] POST_AUTH_WHITELIST = {
            ...
            POST_COUPON_GET_VALIDATE_COUPON_LIST_PATH, POST_USER_AUTH_FIREBASE_REGISTER_PATH, POST_USER_AUTH_FIREBASE_LOGIN_PATH,
    ...
    public static final String[] POST_USER_PATH = {
            ...
            POST_COUPON_CHECK_LIST_IN_CART_PATH, POST_ORDER_REFUND_CREATE_REQUEST_PATH
    };
    ...
    public static final String[] GET_USER_PATH = {
            ...
            GET_COUPON_REWARD_OF_COUPON_LIST_PATH, GET_USER_SPENDING_STATISTIC_PATH, GET_USER_ORDER_STATISTIC_PATH
    };
    ...
    public static final String[] GET_EMPLOYEE_PATH = {
            ...
            GET_EMPLOYEE_STATISTIC_TODAY_PATH
    };
