...
public class SwaggerConstant {
    ...
    public static final String PRODUCT_GET_BRANCH_LIST_SUM = "Get the list of branches by product";
    public static final String PRODUCT_PATCH_CHANGE_BRANCH_PRODUCT_STATUS_SUM = "Update branch product status";
    ...
    public static final String PRODUCT_GET_RECOMMEND = "Recommend products for user";
    ...
    public static final String EMPLOYEE_UPDATE_PASSWORD_SUM = "Update new password by employee id";
    public static final String EMPLOYEE_SET_NEW_PASSWORD_SUM = "Set new password by employee id";
    public static final String EMPLOYEE_GET_ORDER_STATISTIC_SUM = "Get sales data statistics";
    // For Marketing =============================================================
    public static final String MARKETING_CONTROLLER_TITLE = "MARKETING MANAGEMENT";
    ...
    public static final String COUPON_CHECK_EXISTED_NAME_SUM = "Check coupon existence by code";
