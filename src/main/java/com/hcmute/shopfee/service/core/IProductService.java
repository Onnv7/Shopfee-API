...
public interface IProductService {
    ...
    GetAllVisibleProductResponse getVisibleProductList(Long minPrice, Long maxPrice, Integer minStar, ProductSortType productSortType, int page, int size, String key);
